package com.exp.soapmail.config;
...
@EnableWs
@Configuration
public class SoapWsConf extends WsConfigurerAdapter {
    ...
    public ServletRegistrationBean messageDispatcherServlet(ApplicationContext context){
        ...
        return new ServletRegistrationBean(servlet, "/mailWS/*");
    }
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema bankSchema){
        ...
        definition.setLocationUri("/mailWS");
        definition.setPortTypeName("MailService");
